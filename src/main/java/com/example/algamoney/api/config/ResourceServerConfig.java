...
@EnableGlobalMethodSecurity(prePostEnabled = true)//Com esta notação eu consigo habilitar segurança nos métodos
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.and()
				//Aplicação não vai guardar sessão
	...
	/**
	 * Handler para conseguir fazer a segurança dos métodos
	 * com OAuth2
	 * **/
	@Bean
